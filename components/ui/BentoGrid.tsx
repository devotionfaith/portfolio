...
export const BentoGridItem = ({
  ...
  const rightLists = ["ReactJS", "PHP", "Typescript"];
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            titleClassName,
            "relative md:h-full flex flex-col",
            {
        ...
        >
          <div className={`font-sans font-extralight text-left ${id == 2 && "lg:pl-5 lg:pr-8 lg:pb-5"} md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10`}>
            {description}
          </div>
          <div
